    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Kategorien</h2>
        </div>
        <button
          ...
          <div key={category.id} className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <div className="flex justify-between items-start mb-2">
              ...
              <div className="text-right">
                <p className="font-medium text-gray-900 dark:text-white">€{category.budget.toFixed(2)}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Ausgegeben: €{category.spent.toFixed(2)}
                </p>
              </div>
            </div>
